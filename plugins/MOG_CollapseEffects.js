...
/*:
 * @plugindesc (v1.4 *) Adiciona efeitos de colapsos animados.
 * @author Moghunter
 *
 ...
 * - (BUG FIX) - Correção do timming inicial do colapso com  RM 1.6.1+
 * - (BUG FIX) - Correção do timming do som com o Mog Flash Damage.
 */
...
Sprite_Battler.prototype.setupCollapseEffect = function () {
  ...
  } else if (this.collapseType() === 4 || this.collapseType() === 5 || this.collapseType() === 6 || this.collapseType() === 7) {
