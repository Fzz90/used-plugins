...
// Scene_Equip.prototype.createBTN = function () {
//   ImageManager.loadSystem("NextBackBTN");
...
Scene_Equip.prototype.createCompareWindow = function () {
  // var BTN = ImageManager.loadSystem("NextBackBTN");
  this._lowerRightWindows = [];
  this._lowerRightWindows1 = [];
  var wx = this._itemWindow.width;
  var wy = this._itemWindow.y;
  var ww = Graphics.boxWidth - wx;
  var wh = Graphics.boxHeight - wy;
  this._compareWindow = new Window_StatCompare(wx, wy, ww, wh);
  this._customWindow = new Window_Custom(wx, 640, ww, 80);
  ...
  this._lowerRightWindows1.push(this._customWindow);
...
Window_Custom.prototype.initialize = function (x, y, panjang, lebar) {
  Window_Base.prototype.initialize.call(this, x, y, panjang, lebar);
  this.drawAllItems();
};

Window_Custom.prototype.drawAllItems = function () {
  // this.drawIcon(3342, 0, 0);
  // this.drawIcon(3343, 0, 0);
  this.drawText("\\i[" + 3342 + "]" + ` BACK`, 0, 0, this.width - this.padding * 2, "left") +
    this.drawText(`◄ More Information ►`, 0, 0, this.width - this.padding * 2, "center") +
    this.drawText(`NEXT ` + "\\i[" + 3343 + "]", 0, 0, this.width - this.padding * 2, "right");
};
