...
Scene_Shop.prototype.sellingPrice = function () {
  ...
  if (this._item && this._item.sellPrice !== undefined) {
    ...
    // ? ▼ 3% If durability is less than 3% of its max
  } else if (cur <= Math.floor(max - max * 0.03) && cur > Math.floor(max - max * 0.1)) {
    return Math.floor(this._item.price / (2.03 + 0.03));
    // ? ▼ 10%
  } else if (cur <= Math.floor(max - max * 0.1) && cur > Math.floor(max - max * 0.15)) {
    return Math.floor(this._item.price / (2.1 + 0.1));
    // ? ▼ 15%
  } else if (cur <= Math.floor(max - max * 0.15) && cur > Math.floor(max - max * 0.23)) {
    return Math.floor(this._item.price / (2.15 + 0.15));
    // ? ▼ 23%
  } else if (cur <= Math.floor(max - max * 0.23) && cur > Math.floor(max - max * 0.3)) {
    return Math.floor(this._item.price / (2.23 + 0.23));
    // ? ▼ 30%
  } else if (cur <= Math.floor(max - max * 0.3) && cur > Math.floor(max - max * 0.38)) {
    return Math.floor(this._item.price / (2.3 + 0.3));
    // ? ▼ 38%
  } else if (cur <= Math.floor(max - max * 0.38) && cur > Math.floor(max - max * 0.5)) {
    return Math.floor(this._item.price / (2.38 + 0.38));
    // ? ▼ 50%
  } else if (cur <= Math.floor(max - max * 0.5) && Math.floor(max - max * 0.62)) {
    return Math.floor(this._item.price / (2.5 + 0.5));
    // ? ▼ 62%
  } else if (cur <= Math.floor(max - max * 0.62) && cur > Math.floor(max - max * 0.75)) {
    return Math.floor(this._item.price / (2.62 + 0.62));
    // ? ▼ 75%
  } else if (cur <= Math.floor(max - max * 0.75) && cur > Math.floor(max - max * 0.85)) {
    return Math.floor(this._item.price / (2.75 + 0.75));
    // ? ▼ 85%
  } else if (cur <= Math.floor(max - max * 0.85) && cur > Math.floor(max - max * 0.95)) {
    return Math.floor(this._item.price / (2.85 + 0.85));
    // ? ▼ 95%
  } else if (cur <= Math.floor(max - max * 0.95) && cur > Math.floor(max - max * 1)) {
    return Math.floor(this._item.price / (2.95 + 0.95));
    // ? === 100%
  } else if (cur === max) {
