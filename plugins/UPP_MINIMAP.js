...
PLAYER_LOCATOR.prototype = Object.create(Window_Base.prototype);
...
BORDER_WINDOW.prototype = Object.create(Window_Base.prototype);
BORDER_WINDOW.prototype.constructor = BORDER_WINDOW;

BORDER_WINDOW.prototype.initialize = function () {
  var width = Graphics.boxWidth;
  var height = Graphics.boxHeight;
  Window_Base.prototype.initialize.call(this, _pminiMap_X - _miniBorderSize, _pminiMap_X - _miniBorderSize, _pminiMap_Width * $dataMap.width + _miniBorderSize * 2, _pminiMap_Width * $dataMap.height + _miniBorderSize * 2);
  if (_startMapHidden == "true") {
    this.hide();
  }
  this.opacity = 255;
...
NAME_DISPLAY.prototype = Object.create(Window_Base.prototype);
NAME_DISPLAY.prototype.constructor = NAME_DISPLAY;

NAME_DISPLAY.prototype.initialize = function () {
  var width = Graphics.boxWidth;
  var height = Graphics.boxHeight;
  Window_Base.prototype.initialize.call(this, 0, 0, _pminiMap_Width * $dataMap.width + _minimapNamePadding, this.fittingHeight(1) + _minimapNamePadding);
  if (_startMapHidden == "true") {
    this.hide();
  }
