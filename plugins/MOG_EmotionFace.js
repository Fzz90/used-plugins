...
Moghunter.face_RectX_48_F1 = Number(
  Moghunter.parameters["Rect X Front White 48px"] || -30
);
Moghunter.face_RectY_48_F1 = Number(
  Moghunter.parameters["Rect Y Front White 48px"] || -21
);
Moghunter.face_RectX_48_F2 = Number(
  Moghunter.parameters["Rect X Front Iris 48px"] || -32
);
Moghunter.face_RectY_48_F2 = Number(
  Moghunter.parameters["Rect Y Front Iris 48px"] || -26
);
Moghunter.face_RectX_48_F3 = Number(
  Moghunter.parameters["Rect X Front Iris Left Eye 48px"] || 12
);
Moghunter.face_PosX_48_F = Number(
  Moghunter.parameters["Pos X-axis Front 48px"] || 0
);
Moghunter.face_PosY_48_F = Number(
  Moghunter.parameters["Pos Y-axis Front 48px"] || 0
);

Moghunter.face_RectX_48_S1 = Number(
  Moghunter.parameters["Rect X Side White 48px"] || -30
);
Moghunter.face_RectY_48_S1 = Number(
  Moghunter.parameters["Rect Y Side White 48px"] || -21
);
Moghunter.face_RectX_48_S2 = Number(
  Moghunter.parameters["Rect X Side Iris 48px"] || -32
);
Moghunter.face_RectY_48_S2 = Number(
  Moghunter.parameters["Rect Y Side Iris 48px"] || -26
);
Moghunter.face_RectX_48_S3 = Number(
  Moghunter.parameters["Rect X Front Iris Left Eye 48px"] || 12
);
Moghunter.face_PosX_48_S = Number(
  Moghunter.parameters["Pos X-axis Side 48px"] || 0
);
Moghunter.face_PosY_48_S = Number(
  Moghunter.parameters["Pos Y-axis Side 48px"] || 0
);

Moghunter.face_RectX_64_F1 = Number(
  Moghunter.parameters["Rect X Front White 64px"] || -30
);
Moghunter.face_RectY_64_F1 = Number(
  Moghunter.parameters["Rect Y Front White 64px"] || 24
);
Moghunter.face_RectX_64_F2 = Number(
  Moghunter.parameters["Rect X Front Iris 64px"] || -39
);
Moghunter.face_RectY_64_F2 = Number(
  Moghunter.parameters["Rect Y Front Iris 64px"] || 26
);
Moghunter.face_RectX_64_F3 = Number(
  Moghunter.parameters["Rect X Front Iris Left Eye 64px"] || 12
);
Moghunter.face_PosX_64_F = Number(
  Moghunter.parameters["Pos X-axis Front 64px"] || 0
);
Moghunter.face_PosY_64_F = Number(
  Moghunter.parameters["Pos Y-axis Front 64px"] || 0
);

Moghunter.face_RectX_64_S1 = Number(
  Moghunter.parameters["Rect X Side White 64px"] || -30
);
Moghunter.face_RectY_64_S1 = Number(
  Moghunter.parameters["Rect Y Side White 64px"] || 24
);
Moghunter.face_RectX_64_S2 = Number(
  Moghunter.parameters["Rect X Side Iris 64px"] || -39
);
Moghunter.face_RectY_64_S2 = Number(
  Moghunter.parameters["Rect Y Side Iris 64px"] || 26
);
Moghunter.face_RectX_64_S3 = Number(
  Moghunter.parameters["Rect X Side Iris Left Eye 64px"] || 12
);
Moghunter.face_PosX_64_S = Number(
  Moghunter.parameters["Pos X-axis Side 64px"] || 0
);
Moghunter.face_PosY_64_S = Number(
  Moghunter.parameters["Pos Y-axis Side 64px"] || 0
);
...
Game_Interpreter.prototype.facePluginCommand = function (command, args) {
  if (command === "player_face") {
    ...
    if (char) {
      this.setFaceDataChar(args, char);
    }
  } else if (command === "player_face_clear") {
    var id = args[1] != null ? Number(args[1]) : 0;
    var char = this.getPlayerChar(id);
    if (char && char._faceData.enabled) {
...
// * set Face
//==============================
Game_CharacterBase.prototype.setFace = function (
  mode,
  eleft,
  eright,
  x1,
...
Game_CharacterBase.prototype.removeFace = function () {
  if (this._faceData.enabled) {
    this._faceData.needRemove = true;
  }
};
...
// * update Half Body
//==============================
var _mog_Face_sprChar_updateHalfBodySprites =
...
Sprite_Character.prototype.updateFaceBase = function () {
  if (this.canCreateFace()) {
    this.createFaceSprites();
  }
  if (this.needRemoveFaceSprite()) {
...
Sprite_Character.prototype.updateFaceBody = function (sprite) {
  if (!sprite.bitmap) {
    ...
    if (this.needRefreshFaceFrame()) {
      this.setFaceFrame(sprite);
    }
    if (this.needHideFace(sprite)) {
...
Sprite_Character.prototype.needRefreshFaceFrame = function (sprite) {
  if (this._character._faceData.direction != this._character.direction()) {
    return true;
  }
  if (this._character._faceData.needRefresh) {
    return true;
  }
  return false;
};
...
Sprite_Character.prototype.canCreateFace = function () {
  ...
  if (!this._character._faceData.enabled) {
    return false;
  }
  if (!this.bitmap) {
    return false;
...
//==============================
Sprite_Character.prototype.setFaceFrameFront = function (
  sprite,
  pw,
  ph,
  sx,
...
//==============================
Sprite_Character.prototype.setBitmapEyesBack = function (
  sprite,
  sx,
  sy,
  pw,
...
//==============================
Sprite_Character.prototype.setBitmapEyesBackFront = function (
  sprite,
  sx,
  sy,
  pw,
...
//==============================
Sprite_Character.prototype.setBitmapEyesBackFrontHp = function (
  sprite,
  sx,
  sy,
  pw,
...
//==============================
Sprite_Character.prototype.setBitmapEyesBackSide = function (
  sprite,
  sx,
  sy,
  pw,
...
//==============================
Sprite_Character.prototype.setBitmapEyesFront = function (
  sprite,
  sx,
  sy,
  pw,
...
//==============================
Sprite_Character.prototype.setBitmapEyesSide = function (
  sprite,
  sx,
  sy,
  pw,
...
Sprite_Character.prototype.needRemoveFaceSprite = function () {
  ...
  if (this._character._faceData.needRemove) {
    return true;
  }
  return false;
};
...
//==============================
var _mog_face_sprtChar_setCharacterBitmap =
