...
Window_StatusInfo.prototype.drawGeneralExp = function (dx, dy, dw, dh) {
  ...
  // Current Exp
  this.changeTextColor(this.systemColor());
  text = "\\i[2086] \\c[0]Current \\c[4]EXP";
  ...
  dy += this.lineHeight();
  this.changeTextColor(this.systemColor());
  text = "\\i[2084] \\c[0]To Next \\hc[e8e8e8]Level";
  this.drawText(text, dx, dy, dw, "left");
  dy += this.lineHeight();
  var rect = new Rectangle();
  rect.x = dx;
...
Window_StatusInfo.prototype.calcParamRate = function (paramId) {
  ...
  var rate = parseFloat(this._actor.param(paramId) - this._smallestParam) / parseFloat(this._largestParam - this._smallestParam);
  rate *= 0.7;
  rate += 0.3;
  return rate;
};
...
Window_StatusInfo.prototype.elementArray = function () {
  var array = [Yanfly.Param.StatusEleCol1, Yanfly.Param.StatusEleCol2, Yanfly.Param.StatusEleCol4];
  if ($gameSwitches.value(61)) {
    array.splice(2, 0, Yanfly.Param.StatusEleCol3);
  }
  return array;
};
...
Window_StatusInfo.prototype.drawElementData = function (eleId, dx, dy, dw) {
  ...
  if (eleId === 50 && eleId === 51 && eleId === 52) {
    var text = " ";
  } else if (eleId !== 50 && eleId !== 51 && eleId !== 52) {
...
Window_StatusInfo.prototype.stateArray = function () {
  var array = [Yanfly.Param.StatusStateCol1, Yanfly.Param.StatusStateCol2, Yanfly.Param.StatusStateCol3, Yanfly.Param.StatusStateCol4];
  return array;
};
...
Window_StatusInfo.prototype.attributesArray = function () {
  var array = [Yanfly.Param.StatusAttriCol1, Yanfly.Param.StatusAttriCol2, Yanfly.Param.StatusAttriCol3, Yanfly.Param.StatusAttriCol4];
  return array;
};
