...
if (Utils.RPGMAKER_VERSION && Utils.RPGMAKER_VERSION >= "1.5.0") {
  ...
  // ----------------------------RE EDIT-------------------------------------------
  Window_Options.prototype.drawOptionsAdvNorm = function (index, onText, offText) {
    onText = onText || "Advanced";
    offText = offText || "Normal";
    var rect = this.itemRectForText(index);
    var statusWidth = this.statusWidth();
    var halfStatusWidth = this.statusWidth() / 2;
    var titleWidth = rect.width - statusWidth;
  ...
  Window_Options.prototype.drawMinimap = function (index, onText, offText) {
    onText = onText || "Show";
    offText = offText || "Hide";
    var rect = this.itemRectForText(index);
    var statusWidth = this.statusWidth();
    var halfStatusWidth = this.statusWidth() / 2;
    var titleWidth = rect.width - statusWidth;
