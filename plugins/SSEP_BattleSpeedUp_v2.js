  ...
  Spriteset_Battle.prototype.createUpperLayer = function () {
    ...
    button.quickModeToggleSwitch = function () {
      ...
      Sprite_Projectile.prototype.setupProjectile = function (t, e, a, r, i, n, o) {
        ...
        this._moveTargetY = e;
        this._arcPeak = a;
        this._moveDuration = r / Sepher.Param.BattleSpeedBoost || 1 / Sepher.Param.BattleSpeedBoost;
        this._moveTotalDuration = r / Sepher.Param.BattleSpeedBoost;
      ...
      if (QuickMode) {
        ...
        Sprite_Projectile.prototype.setupProjectile = function (t, e, a, r, i, n, o) {
          ...
          this._moveTargetY = e;
          this._arcPeak = a;
          this._moveDuration = r / Sepher.Param.BattleSpeedDefault || 1 / Sepher.Param.BattleSpeedDefault;
          this._moveTotalDuration = r / Sepher.Param.BattleSpeedDefault;
          this._moveType = (i || "LINEAR").toUpperCase();
          this._spin = n;
          this._angled = o;
        };
...
if (Imported.YEP_BattleEngineCore && Imported.Irina_ActionSequenceImpact) {
  ...
  BattleManager.actionPerformAction = function () {
    ...
    if (Sepher.Param.OkayKeyBoost) {
      if (QuickMode || Input.isPressed("ok") || TouchInput.isPressed()) {
        ...
        //Overwrite duration projectile IRINA
        Sprite_Projectile.prototype.setupProjectile = function (t, e, a, r, i, n, o) {
          this._moveTime = 0;
          this._moveBaseX = this.x;
          this._moveBaseY = this.y;
