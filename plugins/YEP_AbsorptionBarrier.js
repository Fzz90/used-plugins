  ...
  for (var n = 1; n < group.length; n++) {
    ...
    for (var i = 0; i < notedata.length; i++) {
      ...
      if (line.match(noteA1)) {
        ...
        obj.targetBarrierEval[evalTurn] = obj.targetBarrierEval[evalTurn] + line + "\n";
        ...
        obj.userBarrierEval[evalTurn] = obj.userBarrierEval[evalTurn] + line + "\n";
        ...
        obj.barrierPenetrationRateEval = obj.barrierPenetrationRateEval + line + "\n";
        ...
        obj.barrierPenetrationFlatEval = obj.barrierPenetrationFlatEval + line + "\n";
      }
    }
  }
};
  ...
  for (var n = 1; n < group.length; n++) {
    ...
    for (var i = 0; i < notedata.length; i++) {
      ...
      if (line.match(/<BARRIER PENETRATION:[ ]([\+\-]\d+)([%％])>/i)) {
        ...
        obj.battleStartBarrierPointsEval[evalTurn] = obj.battleStartBarrierPointsEval[evalTurn] + line + "\n";
      } else if (line.match(noteC1)) {
        ...
        obj.barrierRegenEval[evalTurn] = obj.barrierRegenEval[evalTurn] + line + "\n";
      }
    }
  }
};
...
Yanfly.ABR.Game_BattlerBase_initMembers = Game_BattlerBase.prototype.initMembers;
...
Game_Actor.prototype.barrierPenetrationRateEval = function (c1, c2, c3, c4) {
  var rate = 1 - Game_Battler.prototype.barrierPenetrationRateEval.call(this, c1, c2, c3, c4);
  var length = this.equips().length;
  for (var i = 0; i < length; ++i) {
    var obj = this.equips()[i];
    if (obj && obj.barrierPenetrationRateEval !== undefined) {
...
Game_Actor.prototype.barrierPenetrationFlatEval = function (c1, c2, c3, c4) {
  var value = Game_Battler.prototype.barrierPenetrationFlatEval.call(this, c1, c2, c3, c4);
  var length = this.equips().length;
  for (var i = 0; i < length; ++i) {
    var obj = this.equips()[i];
    if (obj && obj.barrierPenetrationFlatEval !== undefined) {
...
Yanfly.ABR.Game_Action_applyItemUserEffect = Game_Action.prototype.applyItemUserEffect;
...
Game_Action.prototype.gainBarrierBonus = function (target, isTarget) {
  ...
  for (var i = 0; i < length; ++i) {
    ...
    var value = barriers[i] || 0;
    value += target.gainBarrierEval(evalBarriers[i] || "", t, this.subject(), target);
    if (value > 0) {
...
Game_Action.prototype.executeHpDamage = function (target, value) {
  ...
  if (this.isAffectBarrierPoints(target, value)) {
    ...
    // ! A LITTLE CHANGE
    if ($gameSwitches.value(101) == true || target.isActor()) {
      value = target.loseBarrier(value, penRate, penFlat);
    } else {
      value = target.loseBarrier(0);
    }
    // $gameSwitches.value(101) == true ?  value = target.loseBarrier(value, penRate, penFlat) : value = 0;
  }
...
Game_Action.prototype.calcBarrierPenetrationRate = function (target, value) {
  ...
  value *= 1 - this.subject().barrierPenetrationRateEval(this, this.subject(), target, value);
...
Game_Action.prototype.calcBarrierPenetrationFlat = function (target, value) {
  ...
  value += this.subject().barrierPenetrationFlatEval(this, this.subject(), target, value);
  ...
  (function () {
    ...
    Special_Gauge.prototype.update = function () {
      ...
      if (this._type === "hp") {
        ...
        if (Math.abs(this._curAbspRate - this._maxAbspRate) < this._abspSpdRate) this._curAbspRate = this._maxAbspRate;
        if (Math.abs(this._curAbsp - this._maxAbsp) < this._abspSpd) this._curAbsp = this._maxAbsp;
