...
/* ========================================================================== */
{
  ...
  class JoystickController extends BaseButton {
    ...
    isHidden() {
      return super.isHidden() && this.divs[1].style.visibility === "hidden";
    }

    isVisible() {
      return super.isVisible() && this.divs[1].style.visibility === "visible";
    }
  ...
  Eli.MobileControls = {
    ...
    canRefreshButtonsForScene() {
      return !this.controlButton.isHidingButtons && SceneManager._scene;
    },
