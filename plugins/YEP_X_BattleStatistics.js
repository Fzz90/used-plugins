...
if (Imported.YEP_StatusMenuCore) {
  ...
  Yanfly.BStats.Game_BattlerBase_addNewState = Game_BattlerBase.prototype.addNewState;
  ...
  Game_Actor.prototype.increaseKillCount = function (value) {
    ...
    $gameVariables.setValue(26, $gameVariables.value(26) + 1);

    var var35 = $gameVariables.value(35);
    var valueToAdd = value;

    // Array mapping the value of var35 to the corresponding variable ID
    var variableMap = {
    0: 83,  // NEUTRAL
    1: 66,  // PHYSICAL
    2: 67,  // FIRE
    ...
    // Check if var35 is within the range of the variableMap
    if (variableMap.hasOwnProperty(var35)) {
    $gameVariables.setValue(variableMap[var35], $gameVariables.value(variableMap[var35]) + valueToAdd);

   
    }

//     // ^ ANIMAL
//     if (!user.isActor() && user.elementRate(18) >= 3) {
//       $gameVariables.setValue(84, $gameVariables.value(84) + 1);
//   } 
//    // ^ HUMAN
//    if (!user.isActor() && user.elementRate(20) >= 3) {
//     $gameVariables.setValue(85, $gameVariables.value(85) + 1);
// } 
//  // ^ LIVING
//  if (!user.isActor() && user.elementRate(22) >= 3) {
//   $gameVariables.setValue(86, $gameVariables.value(86) + 1);
// }  
//  // ^ WINGED
//  if (!user.isActor() && user.elementRate(24) >= 3) {
//   $gameVariables.setValue(87, $gameVariables.value(87) + 1);
// } 
//  // ^ SUPERNATURAL
//  if (!user.isActor() && user.elementRate(26) >= 3) {
//   $gameVariables.setValue(88, $gameVariables.value(88) + 1);
// } 
//  // ^ PLANT
//  if (!user.isActor() && user.elementRate(28) >= 3) {
//   $gameVariables.setValue(89, $gameVariables.value(89) + 1);
// } 
//  // ^ DRAGON
//  if (!user.isActor() && user.elementRate(30) >= 3) {
//   $gameVariables.setValue(90, $gameVariables.value(90) + 1);
// } 
//  // ^ UNDEAD
//  if (!user.isActor() && user.elementRate(32) >= 3) {
//   $gameVariables.setValue(91, $gameVariables.value(91) + 1);
// } 
//  // ^ GOBLIN
//  if (!user.isActor() && user.elementRate(34) >= 3) {
//   $gameVariables.setValue(92, $gameVariables.value(92) + 1);
// } 
//  // ^ SPIRIT
//  if (!user.isActor() && user.elementRate(36) >= 3) {
//   $gameVariables.setValue(93, $gameVariables.value(93) + 1);
// } 
//  // ^ MAGE
//  if (!user.isActor() && user.elementRate(38) >= 3) {
//   $gameVariables.setValue(94, $gameVariables.value(94) + 1);
// } 
//  // ^ OBJECT
//  if (!user.isActor() && user.elementRate(40) >= 3) {
//   $gameVariables.setValue(95, $gameVariables.value(95) + 1);
// } 
//  // ^ MYTHICAL
//  if (!user.isActor() && user.elementRate(42) >= 3) {
//   $gameVariables.setValue(96, $gameVariables.value(96) + 1);
// } 
//  // ^ CREATURES
//  if (!user.isActor() && user.elementRate(44) >= 3) {
//   $gameVariables.setValue(97, $gameVariables.value(97) + 1);
// } 
//  // ^ MECH
//  if (!user.isActor() && user.elementRate(46) >= 3) {
//   $gameVariables.setValue(98, $gameVariables.value(98) + 1);
// } 
//  // ^ LEGENDARY
//  if (!user.isActor() && user.elementRate(48) >= 3) {
//   $gameVariables.setValue(99, $gameVariables.value(99) + 1);
// } 
  ...
  Yanfly.BStats.Game_Action_executeHpDamage = Game_Action.prototype.executeHpDamage;
  ...
  Yanfly.BStats.Window_StatusCommand_createCommand = Window_StatusCommand.prototype.createCommand;
  ...
  Yanfly.BStats.Window_StatusCommand_addCustomCommands = Window_StatusCommand.prototype.addCustomCommands;
  ...
  Yanfly.BStats.Window_StatusInfo_drawInfoContents = Window_StatusInfo.prototype.drawInfoContents;
  ...
  Window_StatusInfo.prototype.drawBattleCount = function () {
    ...
    var n3 = parseInt((100 * this._actor.battleCount()) / Math.max(1, $gameSystem.battleCount()));
