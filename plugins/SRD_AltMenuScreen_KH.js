...
// ============================================================================
// Bust Picture Support for SRD_AltMenuScreen_KH
// Draw actor bust from img/pictures instead of face index
// ============================================================================
...
(function () {
  ...
  // CONFIG
  const BUST_PREFIX = "Actor_"; // Actor_1.png, Actor_2.png, etc
  const BUST_FOLDER = "pictures";

  // --------------------------------------------------------------------------
  // Override drawItemImage to draw bust picture
  // --------------------------------------------------------------------------
  Window_MenuStatus.prototype.drawItemImage = function (index) {
    ...
    const bitmap = ImageManager.loadPicture(BUST_PREFIX + actor.actorId());
