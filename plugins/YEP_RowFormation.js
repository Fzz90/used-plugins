  ...
  for (var n = 1; n < group.length; n++) {
    ...
    for (var i = 0; i < notedata.length; i++) {
      ...
      if (line.match(noteR1)) {
        ...
        obj.rowOnly = Yanfly.Util.getRange(parseInt(RegExp.$1), parseInt(RegExp.$2));
...
Yanfly.Row.Game_BattlerBase_isStateAffected = Game_BattlerBase.prototype.isStateAffected;
...
Yanfly.Row.Game_BattlerBase_meetsSkillConditions = Game_BattlerBase.prototype.meetsSkillConditions;
...
Yanfly.Row.Game_BattlerBase_meetsItemConditions = Game_BattlerBase.prototype.meetsItemConditions;
...
Yanfly.Row.Game_Action_applyItemUserEffect = Game_Action.prototype.applyItemUserEffect;
...
Game_Action.prototype.applyItemRowEffect = function (target) {
  ...
  if (item.targetRowEval !== "") target.targetRowEval(item.targetRowEval, this.subject(), item);
};
...
Yanfly.Row.Game_Interpreter_pluginCommand = Game_Interpreter.prototype.pluginCommand;
...
Yanfly.Row.Spriteset_Battle_createLowerLayer = Spriteset_Battle.prototype.createLowerLayer;
...
Yanfly.Row.Window_MenuCommand_addFormationCommand = Window_MenuCommand.prototype.addFormationCommand;
...
Yanfly.Row.Scene_Menu_createCommandWindow = Scene_Menu.prototype.createCommandWindow;
...
if (Imported.YEP_BattleEngineCore) {
  ...
  Yanfly.Row.Window_PartyCommand_makeCommandList = Window_PartyCommand.prototype.makeCommandList;
  ...
  Yanfly.Row.Sprite_Actor_moveToStartPosition = Sprite_Actor.prototype.moveToStartPosition;
  ...
  Yanfly.Row.Spriteset_Battle_createBackground = Spriteset_Battle.prototype.createBackground;
  ...
  Yanfly.Row.Scene_Battle_createDisplayObjects = Scene_Battle.prototype.createDisplayObjects;
  Scene_Battle.prototype.createDisplayObjects = function () {
    Yanfly.Row.Scene_Battle_createDisplayObjects.call(this);
    $gameParty.loadActorImages();
  };

  Yanfly.Row.Scene_Battle_createPartyCommandWindow = Scene_Battle.prototype.createPartyCommandWindow;
  ...
  Yanfly.Row.Scene_Battle_createSpriteset = Scene_Battle.prototype.createSpriteset;
