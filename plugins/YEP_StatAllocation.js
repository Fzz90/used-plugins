...
Yanfly.Param.StatAlcDrawCode = new Function("index", Yanfly.Param.StatAlcDrawCode);
...
Yanfly.Param.StatAlcRevConfirmText = JSON.parse(Yanfly.Parameters["RevertConfirmationText"]);
...
Yanfly.SetupParameters = function () {
  Yanfly.Param.StatAlcAPFormula = new Function("level", "return " + String(Yanfly.Parameters["AP Formula"]));
...
Game_Actor.prototype.setParamAllocateTimes = function (paramId, times, classId) {
  ...
  var max = this.getParamAllocateMax(paramId);
  this._paramAllocationTimes[classId][paramId] = this._paramAllocationTimes[classId][paramId].clamp(0, max);
...
Game_Actor.prototype.paramAllocationBonus = function (paramId) {
  ...
  return Math.ceil(this.getParamAllocateTimes(paramId) * this.getParamAllocateBoost(paramId));
};
...
Game_Actor.prototype.setXParamAllocateTimes = function (paramId, times, classId) {
  ...
  var max = this.getXParamAllocateMax(paramId);
  this._xparamAllocationTimes[classId][paramId] = this._xparamAllocationTimes[classId][paramId].clamp(0, max);
  if (Yanfly.Param.StatAlcRefresh) this.refresh();
};
...
Game_Actor.prototype.xparamAllocationBonus = function (paramId) {
  if ($gameTemp._ignoreStatAllocations) return 0;
  return this.getXParamAllocateTimes(paramId) * this.getXParamAllocateBoost(paramId);
};
...
Game_Actor.prototype.setSParamAllocateTimes = function (paramId, times, classId) {
  ...
  var max = this.getSParamAllocateMax(paramId);
  this._sparamAllocationTimes[classId][paramId] = this._sparamAllocationTimes[classId][paramId].clamp(0, max);
  if (Yanfly.Param.StatAlcRefresh) this.refresh();
};
...
Game_Actor.prototype.sparamAllocationBonus = function (paramId) {
  if ($gameTemp._ignoreStatAllocations) return 0;
  return this.getSParamAllocateTimes(paramId) * this.getSParamAllocateBoost(paramId);
};
...
Game_Actor.prototype.bonusAp = function () {
  ...
  this._bonusAllocationPoints[this._classId] = this._bonusAllocationPoints[this._classId] || 0;
  return Math.max(0, this._bonusAllocationPoints[this._classId]);
};

Game_Actor.prototype.spentAp = function () {
  this.initAllocationPointsCheck();
  this._spentAllocationPoints[this._classId] = this._spentAllocationPoints[this._classId] || 0;
...
Yanfly.StatAlc.Game_Interpreter_pluginCommand = Game_Interpreter.prototype.pluginCommand;
...
Yanfly.StatAlc.Window_Base_drawActorStatus = Window_Base.prototype.drawActorSimpleStatus;
...
Yanfly.StatAlc.Window_MenuCommand_addOriginalCommands = Window_MenuCommand.prototype.addOriginalCommands;
...
Yanfly.StatAlc.Scene_Menu_createCommandWindow = Scene_Menu.prototype.createCommandWindow;
Scene_Menu.prototype.createCommandWindow = function () {
  Yanfly.StatAlc.Scene_Menu_createCommandWindow.call(this);
  this._commandWindow.setHandler("statAllocate", this.commandPersonal.bind(this));
};
...
Scene_StatAllocation.prototype.processAllocationCostItems = function (param, data) {
