...
(function (_) {
  ...
  Game_CharacterBase.prototype.centerCamera = function (dur) {
    return $gameMap.setDisplayPosStart(
      this.x - this.centerX(),
      this.y - this.centerY(),
      dur
    );
  ...
  Game_Follower.prototype.updateScroll = function (
    lastScrolledX,
    lastScrolledY
  ) {
  ...
  Game_Map.prototype.setDisplayPosSpeeds = function (dur) {
    ...
    this._displayXSpeed =
      (this._newDisplayX - this._displayX) / this._scrollDuration;
    this._displayYSpeed =
      (this._newDisplayY - this._displayY) / this._scrollDuration;
    this._parallaxXSpeed =
      (this._newParallaxX - this._parallaxX) / this._scrollDuration;
    this._parallaxYSpeed =
      (this._newParallaxY - this._parallaxY) / this._scrollDuration;
  };
  ...
  if (_.pics) {
    Scene_Base.prototype.createPicturesForCameraCore =
