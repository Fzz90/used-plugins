...
/*:
 * @plugindesc (v5.0 *) Permite customizar o layout de batalha.
 * @author Moghunter
 *
 * @param -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 * @desc
...
Game_Interpreter.prototype.pluginCommand = function (command, args) {
  ...
  // RE-WORKED
  // if (command === "8maxactors") {
  //   Moghunter.bhud_max_battle_members = 8;
  // }
  //==========
  return true;
};
...
Window_ActorCommand.prototype.initialize = function () {
  ...
  this.org2 = [this.org[0] + Moghunter.bhud_com_slideX, this.org[1] + Moghunter.bhud_com_slideY];
...
//===Edited======//
var screenLayout = String(Moghunter.bhud_screen_layout);
//==============//
...
Scene_Battle.prototype.createAllWindows = function () {
  ...
  this._partyCommandWindow.org2 = [this._partyCommandWindow.org[0] + Moghunter.bhud_party_slide_x, this._partyCommandWindow.org[1] + Moghunter.bhud_party_slide_y];
  ...
  this._helpWindow.org2 = [this._helpWindow.org[0] + Moghunter.bhud_help_slide_x, this._helpWindow.org[1] + Moghunter.bhud_help_slide_y];
  ...
  this._skillWindow.org2 = [this._skillWindow.org[0] + Moghunter.bhud_skill_slide_x, this._skillWindow.org[1] + Moghunter.bhud_skill_slide_y];
  ...
  this._itemWindow.org2 = [this._itemWindow.org[0] + Moghunter.bhud_item_slide_x, this._itemWindow.org[1] + Moghunter.bhud_item_slide_y];
  ...
  this._actorWindow.org2 = [this._actorWindow.org[0] + Moghunter.bhud_actor_slide_x, this._actorWindow.org[1] + Moghunter.bhud_actor_slide_y];
  ...
  this._enemyWindow.org2 = [this._enemyWindow.org[0] + Moghunter.bhud_enemy_slide_x, this._enemyWindow.org[1] + Moghunter.bhud_enemy_slide_y];
...
Battle_Hud.prototype.set_hud_position = function () {
  ...
  var ps = [Number(Moghunter.bhud_space_x) * this._hud_id, Number(Moghunter.bhud_space_y) * this._hud_id];
...
Battle_Hud.prototype.is_hud_visible = function (sprite) {
  ...
  if (Imported.MOG_ChronoEngine) {
    if ($gameSystem._chronoMode.phase > 3 && $gameSystem._chronoMode.phaseEndPhaseDuration === 0) {
      return false;
    }
  }
  return true;
...
Battle_Hud.prototype.create_hp_number = function () {
  ...
  this._hp_number = [];
  this._hp_img_data = [this._hp_number_img.width, this._hp_number_img.height, this._hp_number_img.width / 10, this._hp_number_img.height / 2, this._pos_x + Moghunter.bhud_hp_number_pos_x, this._pos_y + Moghunter.bhud_hp_number_pos_y];
  for (var i = 0; i < 5; i++) {
...
Battle_Hud.prototype.create_mp_number = function () {
  ...
  this._mp_number = [];
  this._mp_img_data = [this._mp_number_img.width, this._mp_number_img.height, this._mp_number_img.width / 10, this._mp_number_img.height / 2, this._pos_x + Moghunter.bhud_mp_number_pos_x, this._pos_y + Moghunter.bhud_mp_number_pos_y];
  for (var i = 0; i < 5; i++) {
...
Battle_Hud.prototype.create_tp_number = function () {
  ...
  this._tp_number = [];
  this._tp_img_data = [this._tp_number_img.width, this._tp_number_img.height, this._tp_number_img.width / 10, this._tp_number_img.height / 2, this._pos_x + Moghunter.bhud_tp_number_pos_x, this._pos_y + Moghunter.bhud_tp_number_pos_y];
  for (var i = 0; i < 5; i++) {
