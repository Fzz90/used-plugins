...
Yanfly.Gab.Game_Interpreter_pluginCommand = Game_Interpreter.prototype.pluginCommand;
...
Game_Interpreter.prototype.showGab = function () {
  ...
  var gabData = [this._gabText, this._gabGraphicType, this._gabGraphicName, this._gabGraphicIndex, this._gabSoundName, this._gabSwitch];
...
Yanfly.Gab.Game_Interpreter_updateWaitMode = Game_Interpreter.prototype.updateWaitMode;
...
Yanfly.Gab.WindowLayer_webglMaskWindow = WindowLayer.prototype._webglMaskWindow;
...
Window_Gab.prototype.startCountdown = function () {
  ...
  if ($gameParty.inBattle) {
    this._showCount += (text.length * Yanfly.Param.GabTimePerChar) / 1.35;
  } else if ($gameParty.inBattle && QuickMode) {
    this._showCount += (text.length * Yanfly.Param.GabTimePerChar) / 1.675;
  } else {
...
Yanfly.Gab.Scene_Battle_createAllWindows = Scene_Battle.prototype.createAllWindows;
